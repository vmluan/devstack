...
docker-compose exec discovery bash -c 'source /edx/app/discovery/discovery_env && python /edx/app/discovery/discovery/manage.py create_or_update_partner --site-id 1 --site-domain localhost:18381 --code edx --name edX --courses-api-url "http://115.79.29.63:18001/api/courses/v1/" --ecommerce-api-url "http://edx.devstack.ecommerce:18130/api/v2/" --organizations-api-url "http://115.79.29.63:18001/api/organizations/v0/" --oidc-url-root "http://115.79.29.63:18001/oauth2" --oidc-key discovery-key --oidc-secret discovery-secret'
